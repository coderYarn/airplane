  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(_crd && SelfPlane === void 0 ? (_reportPossibleCrUseOfSelfPlane({
        ...
        error: Error()
      }), AudioManager) : AudioManager), _dec(_class = (_class2 = (_temp = class GameManager extends Component {
        constructor(...args) {
          super(...args);
          ...
          _defineProperty(this, "_combinationInterval", (_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
            error: Error()
          }), Constant) : Constant).Combination.PLAN1);

          _defineProperty(this, "_bulletType", (_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
            error: Error()
